...
namespace Cordova.Extension.Commands
{
    ...
    public class SQLitePlugin : BaseCommand
    {
        ...
        {
            //System.Diagnostics.Debug.WriteLine("SQLitePlugin.open():" + options);
            ...
            try
            {
                ...
                optionsStringArray = JsonHelper.Deserialize<String[]>(options);
                dbOptions = JsonHelper.Deserialize<SQLitePluginOpenCloseOptions>(optionsStringArray[0]);
            }
            catch (Exception)
            {
